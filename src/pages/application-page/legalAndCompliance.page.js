...
import CheckBoxBlockComponent from "../../components/Form/tabs-component/checkbox.component";
        ...
        <FormContainer onSubmit={handleSubmit}>
          ...
          <CheckBoxContainer>
            <div style={{ marginBottom: "2rem" }}>
              ...
              <small style={{ color: "#fff" }}>
                Only tick the boxes after reading carefully.
              </small>
            </div>
            ...
            <CheckBox className="" isNotClicked={state.isNotClicked}>
              ...
              <CheckBoxBlock__wrapper>
                <CheckBoxDetails>
                  ...
                  <small>
                    I have read and understand the Disclosure Statement. I am
                    completing this application of my own free will and can
                    understand the language and terms used. Click here to read
            ...
            <CheckBox className="" isNotClicked={state.isNotClicked}>
              ...
              <CheckBoxBlock__wrapper>
                <CheckBoxDetails>
                  ...
                  <small>
                    I have read and understand the cancellation Statement. I am
                    completing this application of my own free will and can
                    understand the language and terms used. Click here to read
            ...
            <CheckBox className="" isNotClicked={state.isNotClicked}>
              ...
              <CheckBoxBlock__wrapper>
                <CheckBoxDetails>
                  ...
                  <small>
                    I have read and understand the Privacy waiver. I am
                    completing this application of my own free will and can
                    understand the language and terms used. Click here to read
                    the Privacy waiver.
                  </small>
            ...
            <CheckBox className="" isNotClicked={state.isNotClicked}>
              ...
              <CheckBoxBlock__wrapper>
                <CheckBoxDetails>
                  <h3>Credit Check</h3>
                  <small>
                    I have read and understand the credit check disclosure. I am
                    completing this application of my own free will and can
                    understand the language and terms used. Click here to read
                    the credit check disclosure." link="Click here to read the
                    credit check disclosure.
                  </small>
                  <a href="">
                    {" "}
                    <small>
                      Click here to read the credit check disclosure.
                    </small>{" "}
                  </a>
                </CheckBoxDetails>
              </CheckBoxBlock__wrapper>
          ...
          <ButtonWrapper>
            {state.disabled ? (
              ...
              <GlobalButton filterApplicants>
                I undestand, continue
              </GlobalButton>
            )}
          </ButtonWrapper>
        </FormContainer>
